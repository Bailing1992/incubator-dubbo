package com.lichao.provider.impl;

import com.lichao.provider.api.HashInterface;
import com.lichao.provider.api.ThrashConfig;
...
public class HashServiceImpl implements HashInterface {
    ...
    public Integer hash(String input) {
        ...
        LOGGER.info("HashService input:{}", input);
        ...
        try {
            ...
            long rtt = nextRTT();
            Thread.sleep(rtt);
            LOGGER.info("HashService output:{}", (input + salt).hashCode());
